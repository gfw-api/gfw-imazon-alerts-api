...
API](http://gfw-api.github.io/swagger-ui/?url=https://raw.githubusercontent.com/gfw-api/gfw-imazon-alerts-api/master/app/microservice/swagger.yml#/IMAZON)

## First time user
Perform the following steps:
* [Install docker](https://docs.docker.com/engine/installation/)
* Clone this repository: ```git clone git@github.com:Vizzuality/gfw-imazon-alerts-api.git```
* Enter in the directory (cd gfw-imazon-alerts-api)
